...
public class Demo {
    public static void main(String[] args) {
        ...
        ((Object) editor.events).subscribe("open", new LogOpenListener("/path/to/log/file.txt"));
        ((Object) editor.events).subscribe("save", new EmailNotificationListener("admin@example.com"));
