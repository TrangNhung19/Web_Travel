(function($) {
    ...
    function productVariantsAjax() {
        ...
        travel.on('mouseenter', function() {
            var variants = $(this).find('.ps-travel__variant');
            if (variants.children().length === 0) {
                setTimeout(function() {
                    $.ajax({
                        url: "../js/travel-variants.js",
    ...
    function productThumbnailChange() {
        var originImageData;
        $('.ps-travel__variants').on('mouseenter', 'img', function() {
            var image = $(this).attr('src');
            var originImage = $(this).closest('.ps-travel').find('.ps-travel__thumbnail img');
    ...
    function productVaritantsNormal() {
        var variants = $('.ps-travel__variant.normal');
        variants.owlCarousel({
            margin: 20,
            autoplay: false,
            loop: false,
