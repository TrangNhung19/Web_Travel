                ...
                <?php
                  ...
                  foreach($cartList as $cart){
                    ...
                    if($arrLinkImage->num_rows > 0){
                        ...
                        $travel_image= "images/product/cart-preview/1.jpg";
                    }
                ?>
                <tr>
                  <td><a class="ps-product__preview" href="product-detail.php?id=<?php echo $cart['travel_id'] ?>"><img width="100" class="mr-15" src="<?php echo $travel_image ?>" alt=""> <?php echo $travel['travel_name'] ?></a></td>
                  <td><span><?php echo $travel['price'] ?></span> VND</td>
                  <td> </td>
                  <td><span id="price<?php echo $count ?>"><?php echo $travel['price'] - $travel['price']*$travel['sale']*0.01 ?></span> VND <span><?php echo "(-".$travel['sale']."%) "; ?></span></td>
                  <td> </td>
                  <td><span><?php echo $cart['travel_size'] ?></span></td>
                  <td> </td>
                  <td><span><?php echo $cart['travel_color'] ?></span></td>
                  <td> </td>
                  <!-- <td>
                  ...
                  <td><span id="total<?php echo $count ?>"><?php echo $travel['price'] - $travel['price']*$travel['sale']*0.01 ?></span> VND</td>
                  <td>
                    <a href="deleteCart.php?userId=<?php echo $infoUser['id'] ?>&travelId=<?php echo $travel['travel_id'] ?>"><div class="ps-remove"></div></a>
                  </td>
                </tr>
                <?php
                    $count++;
